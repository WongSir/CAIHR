...
<head>
    ...
    <section id='content'>
        <div class='container-fluid'>
                                ...
                                <div class='tabbable' style='margin-top: 20px'>
                                    ...
                                    <div class='tab-content'>
                                        <div class="tab-pane active" id="retab1"><!--p>学校用户列表</p-->
                                            <form accept-charset="UTF-8" class="form form-horizontal" method="post" action="<%=request.getContextPath()%>/contract/addContract.action" style="margin-bottom: 0;" />
                                            <div style="margin:0;padding:0;display:inline">
                                                <input name="utf8" type="hidden" value="&#x2713;" />
                                                <input name="authenticity_token" type="hidden" value="CFC7d00LWKQsSahRqsfD+e/mHLqbaVIXBvlBGe/KP+I=" />
                                            </div>
                                            <div class='control-group'>
                                                <label class='control-label' for='inputText1'>合同名称</label>
                                                <div class='controls'>
                                                    <input id='inputText1' placeholder='合同名称' type='text' name="contractName" /><!--修改name与数据库英文名称统一-->
                                                </div>
                                            </div>
                                            <div class='control-group'>
                                                <label class='control-label' for='inputPassword4'>合同编号</label>
                                                <div class='controls'>
                                                    <input id='inputPassword4' placeholder='合同编号' type='text'  name="contractNumber" />
                                                </div>
                                            </div>
                <!--
                <hr class='hr-normal' />
                <div class='control-group'>
                    <label class='control-label' for='inputSelect'>学校名称</label>
                    <div class='controls'>
            ...
            <hr class='hr-normal' />
            <div class='control-group'>
                <label class='control-label' for='inputText1'>签订日期</label>
                <div class='controls'>
                    <input id='inputText1' placeholder='签订日期' type='date'  name="dateOfSignment"/>
                </div>
            </div>
           
            <div class='control-group'>
                <label class='control-label' for='inputText1'>有效期限</label>
                <div class='controls'>
                    <input id='inputText1' placeholder='有效期限' type='text' name="expirtDate"/>
                </div>
            </div>
            <hr class='hr-normal' />
            <div class='control-group'>
                <label class='control-label' for='inputText1'>签订甲方</label>
                <div class='controls'>
                    <input id='inputText1' placeholder='签订甲方' type='text' name="partyA"/>
                </div>
            </div>
            <div class='control-group'>
                <label class='control-label' for='inputText1'>签订乙方</label>
                <div class='controls'>
                    <input id='inputText1' placeholder='签订甲方' type='text' name="partyB"/>
                </div>
            </div>
            <div class='control-group'>
                <label class='control-label' for='inputText1'>合同状态</label>
                <div class='controls'>
                    <input id='inputText1' placeholder='合同状态' type='text' name="contractStatus"/>
                </div>
            </div>
            <div class='control-group'>
                <label class='control-label' for='inputText1'>备注</label>
                <div class='controls'>
                    <input id='inputText1' placeholder='备注' type='text' name="note"/>
                </div>
            </div>
            <!--保存重置-->
