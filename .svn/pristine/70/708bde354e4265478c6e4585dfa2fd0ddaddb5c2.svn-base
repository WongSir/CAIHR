		...
		<div class='navigation'>
			...
			<ul class='nav nav-stacked'>
				...
				<li class=''><a class='dropdown-collapse' href='#'> <i
					...
					<ul class='nav nav-stacked'>
						<li><a class='dropdown-collapse' href='#'> <i
							...
							<ul class='nav nav-stacked'>
								<li class=''><a href='AddEmployeeContract.jsp'> <!--链接到标签对应的html页面-->
										<i class='icon-caret-right'></i> <span>录入员工合同信息</span>
								</a></li>
								<li class=''><a href='ModifiedEmployeeContract.html'> <!--链接到标签对应的html页面-->
										<i class='icon-caret-right'></i> <span>修改员工合同信息表</span>
								</a></li>
						...
						<li class=''><a class='dropdown-collapse' href='#'> <i
							...
							<ul class='nav nav-stacked'>
								<li class=''><a href='UserAdd1.html'> <!--链接到标签对应的html页面-->
										<i class='icon-caret-right'></i> <span>录入新入职员工基本信息</span>
								</a></li>
								<li class=''><a href='modifiedEmployeeInfo.html'> <!--链接到标签对应的html页面-->
										<i class='icon-caret-right'></i> <span>修改员工信息</span>
								</a></li>
								<li class=''><a href='SearchEmployeeInfo.html'> <!--链接到标签对应的html页面-->
										<i class='icon-caret-right'></i> <span>查询员工信息</span>
								</a></li>
								<li class=''><a href='DeleteEmployeeInfo.html'> <!--链接到标签对应的html页面-->
										<i class='icon-caret-right'></i> <span>注销员工信息</span>
								</a></li>
							</ul></li>
						<li class=''><a href='UserAdd.html'> <!--链接到标签对应的html页面-->
								<i class='icon-caret-right'></i> <span>管理试用期员工</span>
						</a></li>
						<li class=''><a href='UserAdd.html'> <!--链接到标签对应的html页面-->
								<i class='icon-caret-right'></i> <span>单位调动</span>
						</a></li>
						<li class=''><a href='UserAdd.html'> <!--链接到标签对应的html页面-->
								<i class='icon-caret-right'></i> <span>岗位调动</span>
						</a></li>
						<li class=''><a href='UserAdd.html'> <!--链接到标签对应的html页面-->
								<i class='icon-caret-right'></i> <span>管理员工档案</span>
						</a></li>
				...
				<li class=''><a class='dropdown-collapse' href='#'> <i
					...
					<ul class='nav nav-stacked'>
						<li class=''><a href='SignUp.html'> <!--链接到标签对应的html页面-->
								<i class='icon-caret-right'></i> <span>报名</span>
						</a></li>
						<li class=''><a href='ModifiedPublicPlan.html'> <!--链接到标签对应的html页面-->
								<i class='icon-caret-right'></i> <span>修改提交公招计划表</span>
						</a></li>
				...
				<li class=''><a class='dropdown-collapse' href='#'> <i
					...
					<ul class='nav nav-stacked'>
						<li class=''><a href='EnteringEmployeeAttendance.html'> <!--链接到标签对应的html页面-->
								<i class='icon-caret-right'></i> <span>录入人员考勤表</span>
						</a></li>
						<li class=''><a href='EnteringDayOffAttendance.html'> <!--链接到标签对应的html页面-->
								<i class='icon-caret-right'></i> <span>录入假日值班考勤</span>
						</a></li>
					</ul></li>
				<!--区县审核-->
				...
				<li class=''><a class='dropdown-collapse' href='#'> <i
					...
					<ul class='nav nav-stacked'>
						...
						<li class=''><a href='Create_schedule.html'> <!--链接到标签对应的html页面-->
								<i class='icon-caret-right'></i> <span>生成发放表</span>
						</a></li>
						...
						<li><a class='dropdown-collapse' href='#'> <i
							...
							<ul class='nav nav-stacked'>
								<li class=''><a href='RuleAdd.html'> <!--链接到标签对应的html页面-->
										<i class='icon-caret-right'></i> <span>增加薪资规则</span>
								</a></li>
								<li class=''><a class='dropdown-collapse' href='#'> <i
			...
			<li class=''><a class='dropdown-collapse' href='#'> <i
				...
				<ul class='nav nav-stacked'>
					<li class=''><a href='UserAdd.html'> <!--链接到标签对应的html页面-->
							<i class='icon-caret-right'></i> <span>项目管理</span>
					</a></li>
				</ul></li>
			<!--高级用户项目管理-->
			...
			<li class=''><a class='dropdown-collapse' href='#'> <i
				...
				<ul class='nav nav-stacked'>
					<li class=''><a href='Serach.html'> <!--链接到标签对应的html页面-->
							<i class='icon-caret-right'></i> <span>查询系统</span>
					</a></li>
				</ul></li>
			<!--查询系统-->
					...
					<div class='row-fluid'>
						<div class='span12'>
							<div class='page-header'>
								<h1 class='pull-left'>
									<i class='icon-edit'></i> <span>查看员工合同登记表</span>
								</h1>
							</div>
						</div>
					</div>
										...
										<table class='data-table table table-bordered table-striped'
											...
											<tbody>
												<c:forEach items="${cList}" var="u">
													<tr>
														<td>${u.contractNumber }</td>
														<td>${u.contractName }</td>
														<td>${u.dateOfSignment }</td>
														<td>${u.expirtDate }</td>
														<td>${u.partyA }</td>
														<td>${u.partyB }</td>
														<td>${u.note }</td>
														<td>${u.contractStatus }</td>
														<td><input type="button" class="btn btn-success"
															value="新增" onclick="addContract()"></td>
														<td><input type="button" class="btn btn-info"
															value="编辑" onclick="modifiedContract(${u.id})"></td>
														<td><input type="button" class="btn btn-danger"
															value="删除" onclick="deleteContract(${u.id})"></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
...
<script type="text/javascript" language="javascript">
	function deleteContract(id) {
		if (confirm("你确定要删除当前选择的信息吗?")) {
	           window.location.href='<%=request.getContextPath()%>/contract/deleteContract.action?id='+ id;
			}
	}
	function addContract() {
           window.location.href='<%=request.getContextPath()%>/BackSite/AddEmployeeContract.jsp';
	}
	function modifiedContract(id) {
		 window.location.href='<%=request.getContextPath()%>/contract/loadContract.action?id='+ id;
	}
</script>
