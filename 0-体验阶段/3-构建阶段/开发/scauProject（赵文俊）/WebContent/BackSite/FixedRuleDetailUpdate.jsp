					...
					<ul class='nav pull-right'>
						...
						<li class='dropdown dark user-menu'><a
							class='dropdown-toggle' data-toggle='dropdown' href='#'> <img
								...
								src=' /scauProject/assets/images/avatar.jpg' width='23' /> <span
						...
						<div class='row-fluid'>
							<div class='span12'>
								<div class='page-header'>
									<h1 class='pull-left'>
										<i class='icon-edit'></i> <span>修改固定值规则信息</span>
									</h1>
								</div>
							</div>
						</div>
						...
						<div class='row-fluid'>
							<div class="tab-pane active" id="retab1">
								...
								<form accept-charset="UTF-8"
									action="<%=request.getContextPath()%>/fixedRuleServlet?type=editSave"
									...
									<div class='control-group'>
										...
										<div class='controls'>
											<input id='inputText1' placeholder='ruleid' type='text'
name="ruleid" value="${FREntity.ruleId}" />
										</div>
									</div>
									...
									<div class='control-group'>
										...
										<div class='controls'>
											<input id='inputText1' placeholder='rulename' type='text'
												name="rulename" value="${FREntity.name}" />
										</div>
									</div>
									<hr class='hr-normal' />
									<div class='control-group'>
										...
										<div class='controls'>
											<input id='inputText1' placeholder='salary' type='text'
												name="salary" value="${FREntity.salary}" />
										</div>
									</div>
									<!--保存重置-->
