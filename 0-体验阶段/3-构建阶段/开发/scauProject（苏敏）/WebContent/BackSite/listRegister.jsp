									...
									<div class="table-responsive">
										<table class="table table-bordered table-hover table-striped">
											...
											<tbody>
												...
												<c:forEach items="${registerList}" var="u">
													<tr>
														<td>${u.name }</td>
														<td>${u.sex }</td>
														<td>${u.education }</td>
														...
														<td><a
															href="<%=request.getContextPath()%>/register/showRegister.action?rId=${u.id}">查看</a>
															&nbsp;&nbsp; <a href="javascript:delRegister(${u.id })">删除</a>
														</td>
													</tr>
												</c:forEach>
...
<script type="text/javascript" language="javascript">
	function delRegister(id) {
		if (confirm("你确定要删除当前选择的信息吗?")) {
           window.location.href='<%=request.getContextPath()%>/register/delRegister.action?rId='+id;
		}
	}
</script>