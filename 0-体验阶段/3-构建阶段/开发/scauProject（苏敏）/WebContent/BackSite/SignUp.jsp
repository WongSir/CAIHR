...
<div class='row-fluid'>
    <div class='span12 box'>
        ...
        <div class='box-content'>
            ...
            -->
            <form id="registerform" onsubmit="return validateUser()"
           		 action="<%=request.getContextPath()%>/register/addRegister.action" method="post"> 
            <div style="margin:0;padding:0;display:inline">
                ...
                <div class='control-group'>
                    ...
                    <div class='controls'>
     			       <input type="text" name="rName" id="rName" value="" placeholder="姓名" id="" class="form-control" />
                ...
                <div class='control-group'>
                    ...
                    <div class='controls'>
     			       <input type="text" name="rCame" id="rCome" value="" placeholder="籍贯" id="" class="form-control" />
                    </div>
                </div>
                <div class='control-group'>
                    <label class='control-label' for='inputText1'>出生年月</label>
                    <div class='controls'>
     			       <input type="text" name="rBirth" id="rBirth" value="" placeholder="出生年月日" id="" class="form-control" />
                    </div>
                </div>
                <div class='control-group'>
                    <label class='control-label' for='inputText1'>联系地址</label>
                    <div class='controls'>
     			       <input type="text" name="rAddress" id="rAddress" value="" placeholder="联系地址" id="" class="form-control" />
                    </div>
                </div>
                <div class='control-group'>
                    <label class='control-label' for='inputText1'>联系电话</label>
                    <div class='controls'>
     			       <input type="text" name="rPhone" id="rPhone" value="" placeholder="手机号码" id="" class="form-control" />
                    </div>
                </div>
                <div class='control-group'>
                    <label class='control-label' for='inputText1'>身份证号码</label>
                    <div class='controls'>
     			       <input type="text" name="rIdentityId" id="rIdentityId" value="" placeholder="身份证号码" id="" class="form-control" />
                    </div>
                </div>
                <div class='control-group'>
                    <label class='control-label' for='inputText1'>最高学历</label>
                    <div class='controls'>
							<select name="rEducation" id="rEducation" class="form-control">
								<option value="">--- 请选择 ---</option>
                ...
                <div class='control-group'>
                    ...
                    <div class='controls'>
     			       <input type="text" name="rMajor" id="rMajor" value="" placeholder="专业" id="" class="form-control" />
                    </div>
                </div>
                <div class='control-group'>
                    <label class='control-label' for='inputText1'>毕业院校</label>
                    <div class='controls'>
     			       <input type="text" name="rSchool" id="rSchool" value="" placeholder="学校" id="" class="form-control" />
                    </div>
                </div>
                <div class='control-group'>
                    <label class='control-label' for='inputText1'>职业技能</label>
                    <div class='controls'>
     			       <input type="text" name="rSchool" id="rSchool" value="" placeholder="技能" id="" class="form-control" />
                    </div>
                </div>
                ...
                <div class='control-group'>
                    ...
                    <div class='controls'>
     			       <input type="text" name="rTime" id="rTime" value="" placeholder="例：1" id="" class="form-control" />
                    </div>以年为单位，填写数字
                </div>
                <div class='control-group'>
                    <label class='control-label' for='inputText1'>工作经历</label>
                    <div class='controls'>
     			       <input type="text" name="rExperience" id="rExperience" value="" placeholder="工作经历" id="" class="form-control" />
                    </div>
                </div>
                <div class='control-group'>
                    <label class='control-label' for='inputText1'>自我评价</label>
                    <div class='controls'>
     			       <input type="text" name="rSelfEvaluate" id="rSelfEvaluate" value="" placeholder="自我评价" id="" class="form-control" />
                    </div>
                </div>
				...
				<div class='form-actions'>
					<button class='btn btn-primary'
						onclick="$('#registerform').submit()" type="button">
